  ...
  return (
    <div className="min-h-screen bg-[var(--theme-bg-primary)] relative">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
        {/* Hero Section */}
        <div className="mb-10">
          <div className="relative bg-[var(--theme-bg-secondary)] border border-[var(--theme-border)] rounded-2xl p-8 overflow-hidden">
            {/* Top accent line */}
            ...
            <div className="relative">
              ...
              <div className="flex items-start justify-between">
                <div className="max-w-2xl">
                  <span className="text-[10px] font-mono text-[var(--theme-text-subtle)] uppercase tracking-wider mb-2 block">// COMPARE_STATS</span>
                  <h1 className="text-4xl font-bold text-white mb-4 tracking-tight font-[family-name:var(--font-family-display)]">
                    COMPARE
                  </h1>
                  <p className="text-lg text-[var(--theme-text-muted)] leading-relaxed">
                ...
                <div className="hidden md:block">
                  <div className="relative">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-violet-500/5 border border-[var(--theme-border)] flex items-center justify-center">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-4">
            <span className="text-[10px] font-mono text-[var(--theme-text-subtle)] uppercase tracking-wider">// SELECT_PLATFORM</span>
        ...
        <div className="mt-16 pt-12 border-t border-[var(--theme-border)]">
          ...
          <div className="relative bg-[var(--theme-bg-secondary)] border border-[var(--theme-border)] rounded-xl p-8 text-center overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-white mb-2 font-[family-name:var(--font-family-display)]">
              FULL SOCIAL FEATURES COMING SOON
            </h3>
            <p className="text-sm text-[var(--theme-text-muted)] mb-6 max-w-md mx-auto">
            ...
            <Link href="/dashboard">
              <button className="group relative inline-flex items-center gap-2 px-5 py-2.5 overflow-hidden rounded-xl">
                ...
                <span className="relative font-semibold text-white text-sm uppercase tracking-wide font-[family-name:var(--font-family-display)]">Return to Dashboard</span>
