...
// PC platforms that support "Active Session" feature (can launch games)
const PC_PLATFORMS = ['Steam', 'Windows', 'Epic', 'EA App', 'Battle.net'];

function isPCPlatform(platform: string): boolean {
  return PC_PLATFORMS.some(p => platform.toLowerCase().includes(p.toLowerCase()));
}
...
export default function GameDetailPage() {
  ...
  const isPC = isPCPlatform(game.platform);

  const statusConfig: Record<string, { label: string; color: string; gradient: string; icon: string }> = {
    playing: {
      label: isPC ? 'Active Session' : 'Now Playing',
      color: 'emerald-500',
      gradient: 'from-emerald-500/20 via-emerald-500/5 to-transparent',
      icon: '▶'
    },
    completed: { label: 'Mission Complete', color: 'blue-500', gradient: 'from-blue-500/20 via-blue-500/5 to-transparent', icon: '✓' },
    '100_completed': { label: '100% Mastered', color: 'purple-500', gradient: 'from-purple-500/20 via-purple-500/5 to-transparent', icon: '★' },
            ...
            <div className="max-w-[1800px] mx-auto">
              <div className="grid grid-cols-1 xl:grid-cols-[400px_1fr] gap-12">
                ...
                <div className="relative group perspective-1000">
                  ...
                  {/* Status Indicator - Only show for PC platforms when playing, or for all platforms with other statuses */}
                  {(game.status !== 'playing' || isPC) && (
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <div className="text-xs uppercase tracking-[0.2em] text-yellow-400/70 mb-1">Trophies</div>
                        <div className="text-3xl font-black text-white tabular-nums">
