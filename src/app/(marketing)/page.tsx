      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="max-w-5xl mx-auto text-center pt-20 pb-32">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-24">
            ...
            <Link href="/features" className="px-8 py-4 bg-transparent border-2 border-white/20 hover:border-cyan-400 text-white hover:text-cyan-400 font-bold rounded-full text-lg transition-all hover:shadow-lg hover:shadow-cyan-500/20">
              Learn More
            </Link>
          </div>
