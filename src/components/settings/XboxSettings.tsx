        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-theme-primary truncate">{profile.xbox_gamertag}</p>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <input
              ...
              className="w-full px-3 py-1.5 bg-theme-hover border border-theme rounded-lg text-xs text-theme-primary placeholder:text-theme-subtle focus:outline-hidden focus:border-green-500/50 font-mono"
            />
