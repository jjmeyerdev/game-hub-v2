...
export function ActiveSessionWidget({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-emerald-500/20 bg-[var(--theme-bg-secondary)]">
      {/* HUD corners */}
      ...
      <div className="relative p-6">
        ...
        {/* Game title */}
        <h3 className="text-2xl font-bold text-[var(--theme-text-primary)] mb-6 font-[family-name:var(--font-family-display)] uppercase">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-mono font-medium text-[var(--theme-text-subtle)] uppercase tracking-wider">Session</span>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-mono font-medium text-[var(--theme-text-subtle)] uppercase tracking-wider">Started</span>
            </div>
            <div className="flex items-baseline">
              <span className="text-xl font-semibold font-mono text-[var(--theme-text-muted)]">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-mono font-medium text-[var(--theme-text-subtle)] uppercase tracking-wider">Today</span>
            </div>
            <div className="flex items-baseline gap-1">
      ...
      {/* Bottom progress bar */}
      <div className="h-0.5 bg-[var(--theme-border)]">
