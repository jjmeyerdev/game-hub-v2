...
export function DashboardHeader({ userName, greeting, onAddGame }: DashboardHeaderProps) {
  return (
    <header className="bg-abyss/80 backdrop-blur-xl border-b border-steel px-8 py-6 sticky top-0 z-40 overflow-hidden">
      ...
      <div className="flex items-center justify-between w-full relative">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-cyan-400 hover:from-cyan-400 hover:to-cyan-300 text-void font-bold rounded-lg text-sm transition-all flex items-center space-x-2">
