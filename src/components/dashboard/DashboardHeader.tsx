...
export function DashboardHeader({
  ...
  return (
    <header className="border-b border-theme bg-theme-secondary/80 backdrop-blur-xl sticky top-0 z-30">
      {/* Subtle top gradient */}
      ...
      <div className="relative px-8 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Divider */}
            <div className="h-8 w-px bg-linear-to-b from-transparent via-border to-transparent" />
            ...
            <div>
              ...
              <h1 className="text-2xl font-bold text-theme-primary tracking-tight font-family-display">
                {userName}
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            {/* System status */}
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-theme-tertiary border border-theme">
            ...
            <div className="h-8 w-px bg-linear-to-b from-transparent via-border to-transparent hidden md:block" />

            {/* Date */}
            <div className="text-right hidden sm:block">
              <p className="text-[9px] font-mono text-theme-muted uppercase tracking-[0.2em] mb-1">Local Date</p>
              <p className="text-sm text-theme-secondary font-medium">{currentDate}</p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="px-5 py-3 bg-theme-tertiary border border-theme rounded-xl">
                <span className="text-2xl font-bold text-cyan-400 tabular-nums tracking-wider font-family-display">
                  {currentTime}
                </span>
              </div>
            </div>
