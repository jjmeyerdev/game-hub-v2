...
export function DashboardHeader({
  ...
  return (
    <header className="relative border-b border-white/[0.04] bg-abyss/80 backdrop-blur-xl sticky top-0 z-30">
      {/* Subtle top gradient */}
      ...
      <div className="relative px-8 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Divider */}
            <div className="h-8 w-px bg-gradient-to-b from-transparent via-white/[0.08] to-transparent" />
            ...
            <div>
              ...
              <h1 className="text-2xl font-bold text-white tracking-tight font-[family-name:var(--font-family-display)]">
                {userName}
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-8 w-px bg-gradient-to-b from-transparent via-white/[0.08] to-transparent hidden md:block" />

            {/* Date */}
            <div className="text-right hidden sm:block">
              <p className="text-[9px] font-mono text-white/30 uppercase tracking-[0.2em] mb-1">Local Date</p>
              <p className="text-sm text-white/60 font-medium">{currentDate}</p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="px-5 py-3 bg-white/[0.02] border border-white/[0.06] rounded-xl">
