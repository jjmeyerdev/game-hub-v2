...
export function GameListItem({ game, index, onEdit, onDelete }: GameListItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gradient-to-r from-deep via-abyss to-deep border-2 border-steel rounded-xl overflow-hidden transition-all duration-300 hover:border-cyan-500/50 hover:shadow-[0_0_30px_rgba(0,217,255,0.15)]">
        ...
        <div className="relative flex items-center gap-6 p-5">
          ...
          <div className="relative flex-shrink-0">
            <div className="w-24 h-32 rounded-lg overflow-hidden border-2 border-steel group-hover:border-cyan-500/50 transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(0,217,255,0.2)]">
              {game.game?.cover_url ? (
                <>
                  <img
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-slate via-steel to-deep hidden items-center justify-center">
                    <Library className="w-8 h-8 text-gray-700 opacity-30" />
                  </div>
                </>
              ) : (
          ...
          <div className="flex-1 min-w-0 space-y-3">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="text-2xl font-bold text-white group-hover:text-cyan-400 transition-colors duration-300 line-clamp-1 mb-1">
                  {game.game?.title || 'Untitled'}
                </h3>
                <div className="flex items-center gap-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-deep border border-steel rounded-md text-xs font-bold text-cyan-400 uppercase tracking-wider">
              ...
              <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <button
                  ...
                  className="p-2 bg-gradient-to-br from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 rounded-lg text-void transition-all transform hover:scale-110 shadow-lg hover:shadow-cyan-500/50"
                  title="Edit game"
                >
                ...
                <button
                  ...
                  className="p-2 bg-gradient-to-br from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 rounded-lg text-white transition-all transform hover:scale-110 shadow-lg hover:shadow-red-500/50"
                  title="Delete game"
                >
