  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "bg-abyss border-steel text-white hover:border-cyan-500/50 hover:bg-deep",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "bg-deep border-cyan-500/30 backdrop-blur-xl",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "text-gray-300 hover:text-white hover:bg-cyan-500/10 focus:bg-cyan-500/10 focus:text-white",
